class Video {
    ...
    displayPhotographMedia() {
        ...
        <video>
        <source src="${Video.folder + this.video}">
        </video>
            <div>
    ...
    displayImageInLightbox() {
        ...
        document.getElementsByClassName("light-box-body")[0].insertAdjacentHTML("beforeend", `<video autoplay><source src = ${Video.folder + this.video} type="video/mp4"></source></video>`);
    }
    prepareLightbox() {
        document.getElementById(this.id).getElementsByTagName("video")[0].addEventListener('click', () => {
